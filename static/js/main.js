...
(function ($) {
    ...
    $('.js-show-modal1').on('click', function(e) {
        ...
        $('#imgPic11').attr('data-thumb', selectedImageUrl);
        ...
        $('#imgPic21').data('thumb', selectedImage2Url);
